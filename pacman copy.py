            ...
            try:
                ...
                if type(collision) is IntersectionCollision:
                    ...
                    if ghost.last_intersection is not collision.collided_with[0]:
                        ghost.current_dir = collision.collided_with[0].choose_dir(ghost.current_dir)
...
class Ghost(Player):
    ...
    Class Attributes:
        speed <int> -- The magnitude that speed should be changed by for
                       Ghosts.
    """
    ...
    def __mul__(self, num: int) -> list:
        ...
        Always returns this instance as long as num is at least 1. Returns an empty list if num is less than 1.

        Parameters:
        -- num: The number of Ghosts to return. Will make duplicates if greater than 1.
